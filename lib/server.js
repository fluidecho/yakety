...
const preview       = require('preview')('yakkety-server');
...
var YakketyServer = function () {
	preview('YakketyServer');
...
util.inherits(YakketyServer, events.EventEmitter); 
module.exports = YakketyServer;
